...
const KPIS_CONFIG = [
    ...
    { key: "gastoPctSobreFacturado", label: "Gasto operativo % del valor despachado neto", format: "pct", accent: "var(--color-primary)" },
...
function renderTotalesFlota(grid, items, unidadLabel) {
    ...
    const tarjetas = [
        ...
        { label: "Gasto operativo % del valor despachado neto", valor: pctSobre(totalGastado, totalFacturadoNeto), accent: "var(--color-primary)" },
