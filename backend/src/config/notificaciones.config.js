...
const TIPOS = {
  ...
  seguro_proximo: { categoria: "documentacion", prioridad: "alta", titulo: "Póliza Seguro próxima a vencer" },
  ...
  aprobacion_requerida: { categoria: "mantenimiento", prioridad: "media", titulo: "Aprobación requerida" },
